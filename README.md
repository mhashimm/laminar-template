# Scala.js with sbt, Vite, Laminar 

This template is a clone of [ScalaJS tutorial repository](https://github.com/sjrd/scalajs-sbt-vite-laminar-chartjs-example/tree/scalajs-vite-end-state) updated to Scala 3.3.0
